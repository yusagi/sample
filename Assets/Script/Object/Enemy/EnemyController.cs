...
//	// コンポーネント
//	public AnimationManager m_AnmMgr;
//	// 付属クラス
...
//				m_AnmMgr.ChangeAnimation(data._anmName, 0.1f, 0, 1);
//				damage = data._attack;
//			}
//			break;
...
//		GameManager.m_Player.GetComponent<GrgrCharCtrl>().hp -= damage;
//	}
...
//		while(!isActionStart){
//			float distance = Vector3.Distance(rigidbody.prevPosition, GameManager.m_Player.GetComponent<GrgrCharCtrl>().rigidbody.prevPosition);
